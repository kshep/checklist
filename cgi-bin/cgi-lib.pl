...
#
# Thanks are due to many people for reporting bugs and suggestionn
...
# ReadParse
# Reads in GET or POST data, converts it to unescaped text, and putn
...
# to combine both the form and the script in one place.  If no parametern
